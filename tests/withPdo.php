...
class WithPdo extends PHPUnit_Framework_TestCase {
  ...
  public function testSetUp() {
    ...
    $this->assertEquals($S->getDb()->__toString(), "dbPdo");
  ...
  public function testDropCreate() {
    ...
    $n = $S->query("create table members (rowid int(11) auto_increment, ".
                   "fname text, lname text, visits int, visittime datetime, ".
                   "primary key(rowid)) engine=MyISAM");
//    $n = $S->query("create table members (fname text, lname text, ".
//                   "visits integer, visittime datetime)"); // for sqlite3
//    $n = $S->query("create table members (rowid serial primary key,".
//                   "fname text, lname text, visits integer, visittime datetime)");
    $this->assertTrue($n == 0);
  }
  ...
  public function testSelect() {
    ...
    $this->assertEquals($lname, 'Phillips1', "testSelect lname=$lname");
    $S->finalize();
  }
